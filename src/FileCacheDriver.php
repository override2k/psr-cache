...
class FileCacheDriver implements CacheItemPoolInterface
{
     ...
     *
     * @param string $path Cache storage path
     */
    public function __construct($path = null)
    {
        $this->path = is_dir($path) ? $path : __DIR__ . '/../cache/';
    }
    ...
    public function commit()
    {
        ...
        foreach ($this->cachepool as $item) {
    ...
    /**
     * Returns current cache driver storage path
     *
     * @return string
     */
